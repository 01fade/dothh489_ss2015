...
void main(){
    ...
    finalColor += (circle(uv, c, 240.0, 2.0) + dots(uv,c,400.));
    finalColor += circle3(uv, c, 313.0, 10.0) * blue1;
    finalColor += triangles(uv, c, 315.0 + 30.0*sin(u_time)) * blue2;
    finalColor += movingLine(uv, c, 240.0) * red;
    finalColor += circle(uv, c, 10.0, 1.0) * red;
